...
@endcomponent
        <form action="{{ route('admin.patients.update', $patient->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('birthday') is-invalid @enderror" id="inputBirthday" name="birthday" value="{{ old('birthday') ? old('birthday') : $patient->birthday }}" max="{{ date('Y-m-d') }}" placeholder="Birthday" required>
            </div>
            <div class="form-group">
